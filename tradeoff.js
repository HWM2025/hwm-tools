...
function selScenario(el, key) {
  ...
  document.getElementById('inputPanelTitle').textContent = scenarioTitles[key] || 'Your numbers';
  document.getElementById('inputPanelNote').textContent = scenarioNotes[key] || '';
  document.getElementById('inputPanelFields').innerHTML = scenarioFields[key] || '';
